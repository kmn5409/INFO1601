function Hello2(){
    ...
    var num = 1;
    var val1 = localStorage.getItem("scomment" + num.toString());
    while(val1 != null && val!=null){
        ...
        num= num+1;
        val1 = localStorage.getItem("scomment" + num.toString());
    }
}
...
function addComment(){
    ...
    if(localStorage.getItem("scomment1") == null){
        localStorage.setItem("scomment1",comment)
    }else{
        var num = 1;
        var val = localStorage.getItem("scomment" + num.toString());
        var element = document.getElementById("comment");
        ...
        while(val != null ){
            ...
            element.appendChild(para);
            num= num+1;
            val = localStorage.getItem("scomment" + num.toString());
        }
        var para = document.createElement("li");
        ...
        var element = document.getElementById("comment");
        element.appendChild(para);
        localStorage.setItem("scomment" + num.toString(),comment)
    }
