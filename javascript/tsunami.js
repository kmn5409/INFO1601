function Hello2(){
    ...
    var num = 1;
    var val1 = localStorage.getItem("tcomment" + num.toString());
    while(val1 != null && val!=null){
        ...
        num= num+1;
        val1 = localStorage.getItem("tcomment" + num.toString());
    }
}
...
function addComment(){
    ...
    if(localStorage.getItem("tcomment1") == null){
        localStorage.setItem("tcomment1",comment)
    }else{
        var num = 1;
        var val = localStorage.getItem("tcomment" + num.toString());
        var element = document.getElementById("comment");
        ...
        while(val != null ){
            ...
            element.appendChild(para);
            num= num+1;
            val = localStorage.getItem("tcomment" + num.toString());
        }
        var para = document.createElement("li");
        ...
        var element = document.getElementById("comment");
        element.appendChild(para);
        localStorage.setItem("tcomment" + num.toString(),comment)
    }
